...
VOID_INFUSION = {
    ...
    "avoidable": True,
    "category": "Boss Kite",
    "failure_type": "Boss absorbed mechanic",
...
DESPOTIC_COMMAND = {
    ...
    "avoidable": True,
    "category": "Spread",
    "failure_type": "Players too close",
    "counts_as_failure": True,
...
TORTURUS_EXTRACT = {
    ...
    "failure_type": "Player standing in bad",
    "counts_as_failure": True,
...
DESTABILIZING_STRIKES = {
    ...
    "failure_type": "Player took boss threat",
    "counts_as_failure": True,
...
VOID_CRUSH = {
    ...
    "failure_type": "Player didn't resist gravity pull",
    "counts_as_failure": True,
    "max_reasonable_hits": 1,
    "score_per_hit": 20,
    "applies_to": ALL_ROLES,
...
QUINTESSENCE = {
    ...
    "severity": "Major",
    "avoidable": True,
    "category": "Ground missiles",
    "failure_type": "Avoid ground missiles.",
    "counts_as_failure": True,
    "max_reasonable_hits": 1,
    "score_per_hit": 20,
    "applies_to": ALL_ROLES,
